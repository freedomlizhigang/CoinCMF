...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wx0845c4b247acd58c'),         // AppID
    'secret'  => env('WECHAT_SECRET', 'c68b97056e850850292c810fe375976c'),     // AppSecret
    
    // 'app_id'  => env('WECHAT_APPID', 'wx1bb03278d5d74909'),         // AppID
    // 'secret'  => env('WECHAT_SECRET', 'd8f9f0b33a89b1b78038c9fbe9b9d29a'),     // AppSecret
    
    'token'   => env('WECHAT_TOKEN', 'lzg2017'),          // Token
    'aes_key' => env('WECHAT_AES_KEY', 'pfMaXUvbk46Rhii7wVpoJkUcxhSjQujZSsoe08sWYGw'),                    // EncodingAESKey
     ...
     */
    'mini_program' => [
        'app_id'  => env('WECHAT_MINI_PROGRAM_APPID', 'wx1d99bcc1f07ebd6b'),
    ...
    'oauth' => [
        ...
        'callback' => env('WECHAT_OAUTH_CALLBACK', '/wxlogin'),
    ],

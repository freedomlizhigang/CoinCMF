...
Route::group(['prefix'=>'c-api','namespace' => 'Admin','middleware'=>['c-api']],function(){
    // 友情链接管理
    Route::group(['prefix' => 'link','namespace' => 'Admin\Content', function (){
    ...
    // 广告管理
    Route::group(['prefix' => 'ad', 'namespace' => 'Admin\Content', function () {
    ...
    // 广告位管理
    Route::group(['prefix' =>'adpos', 'namespace' => 'Admin\Content', function () {
    ...
    // 文章管理用的
    Route::group(['prefix' => 'article', 'namespace' => 'Admin\Content', function () {
    ...
    // 栏目
    Route::group(['prefix' => 'cate', 'namespace' => 'Admin\Content', function () {
    ...
    // 分类管理
    Route::group(['prefix' => 'type', 'namespace' => 'Admin\Common', function () {
    ...
    // 系统配置
    Route::group(['prefix' => 'config', 'namespace' => 'Admin\Common', function () {
    ...
    // 日志
    Route::group(['prefix' => 'log', 'namespace' => 'Admin\Rbac', function () {
        Route::get('list', 'LogController@getList');
        Route::post('clear', 'LogController@postClear');
    }]);
    // 个人修改资料
    Route::group(['prefix' => 'admin', 'namespace' => 'Admin\Rbac', function () {
    ...
    // 角色管理
    Route::group(['prefix' => 'role', 'namespace' => 'Admin\Rbac', function () {
    ...
    // 部门管理
    Route::group(['prefix' => 'section', 'namespace' => 'Admin\Rbac', function () {
    ...
    // 左侧导航菜单
    Route::group(['prefix' => 'menu', 'namespace' => 'Admin\Rbac', function () {

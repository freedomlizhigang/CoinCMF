<table class="table-striped table">
    <tr>
        <td>数量：</td>
        <td>
            <input type="number" step="1" name="option[nums]" class="form-control input-sm" value="{{ optional($option)->nums }}">
    ...
    <tr>
        <td>大小：</td>
        <td>
            <input type="number" step="1" name="option[sizes]" class="form-control input-sm" value="{{ optional($option)->step }}">

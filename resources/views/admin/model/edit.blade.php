<form action="javascript:ajax_submit();" method="post" id="form_ajax">
	...
	<table class="table table-striped">
        ...
        <tr>
            ...
            <td>
                <textarea name="data[describe]" class="form-control" rows="5">{{ old('data.describe',$info->describe) }}</textarea>
	...
	<div class="modal-footer">
        ...
        <div onclick='ajax_submit_form("form_ajax","{{ url('/console/model/edit',['id'=>$info->id]) }}")' name="dosubmit" class="btn btn-info">提交</div>
    </div>
</form>
<form action="javascript:ajax_submit();" method="post" id="form_ajax">
	...
	<table class="table table-striped">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="data[tablename]" class="form-control input-sm" value="{{ old('data.tablename') }}">
                <p class="input-info"><span class="color_red">*</span>最多50字符</p>
            </td>
        </tr>
        <tr>
	...
	<div class="modal-footer">
        ...
        <div onclick='ajax_submit_form("form_ajax","{{ url('/console/model/add') }}")' name="dosubmit" class="btn btn-info">提交</div>
    </div>
</form>